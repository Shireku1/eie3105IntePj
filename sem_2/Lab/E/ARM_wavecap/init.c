...
void TIM4_CH1_IC1_init(void) {
  ...
  timerInitStructure.TIM_Period = 200-1;  //0.01ms*50000 = 500ms
...
void TIM3_CH1_PWM_init(void) {
  ...
  timerInitStructure.TIM_Prescaler = 720-1;  //1/(72Mhz/720)=0.01ms
  timerInitStructure.TIM_CounterMode = TIM_CounterMode_Up;
  timerInitStructure.TIM_Period = 200-1;  //5000: 20Hz=(0.00001s*5000)^-1   500Hz:T=200
  timerInitStructure.TIM_ClockDivision = TIM_CKD_DIV1;
  timerInitStructure.TIM_RepetitionCounter = 0;
  ...
  TIM_Cmd(TIM3, ENABLE);
	...
	outputChannelInit.TIM_Pulse = 10-1; 
